...
/////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($row_auditoria == 0){
		$query_auditoria = "INSERT INTO AUDITORIA (AUD_ID, USU_ID, AUD_DESCRIPCION) VALUES (1,$user,'Modificó estado autor')";
		...
		$auditoria = "INSERT INTO AUDITORIA (AUD_ID, USU_ID, AUD_DESCRIPCION) VALUES ($aux_auditoria,$user,'Modificó estado autor')";
